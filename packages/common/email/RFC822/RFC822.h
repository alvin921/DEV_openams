/*
** $Id: rfc822.h,v 1.21 2000/11/25 23:51:41 mrsam Exp $
*/
#ifndef	rfc822_h
#define	rfc822_h
...
*/
    /****************** qiulin 6/21/2004  10:55 Announce ********************* 
	       I erase the code below according the compile result of the ARM,
		   but I am not sure the validity of the action, maybe it will cause 
		   some potential error, so I am not recommend to delete warning without
		   read code carefully.
