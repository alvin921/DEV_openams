...
void	Mapper235_Reset(Mapper *mapper)
{
	INT i;
...
void	Mapper235_Write( Mapper *mapper, WORD addr, BYTE data )
{
...
Mapper * Mapper235_New(NES* parent)
{
	Mapper *mapper = (Mapper *)MALLOC(sizeof(Mapper235));
	
	memset(mapper, 0, sizeof(Mapper235));
	mapper->nes = parent;
	memcpy(&mapper->vtbl, &MapperBaseVtbl, sizeof(MapperBaseVtbl));
	mapper->vtbl.Reset = Mapper235_Reset;
	mapper->vtbl.Write = Mapper235_Write;
